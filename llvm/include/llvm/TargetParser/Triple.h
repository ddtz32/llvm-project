...
public:
  enum ArchType {
    ...
    toy32,       // toy (32-bit, little endian): toy32
    toy64,       // toy (64-bit, little endian): toy64
    sparc,       // Sparc: sparc
...
public:
  ...
  /// Tests whether the target is toy (32- and 64-bit).
  bool isToy() const {
    return getArch() == Triple::toy32 || getArch() == Triple::toy64;
  }
